...
void Renderer::RenderScene() {
	...
	for (int i = 0; i < 3; ++i) {
		...
		modelMatrix = Matrix4::Translation(tempPos) * Matrix4::Rotation(upRotation, Vector3(0, 0, 1)) * Matrix4::Rotation(rotation, Vector3(0, 1, 0)) * Matrix4::Scale(Vector3(scale, scale, scale));
